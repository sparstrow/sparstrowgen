...
/* Provider marks — the vendors' real logos.
 *
 * Path data extracted from @lobehub/icons (MIT, © 2023 LobeHub), whose Mono
 * variants are single-path and already draw in `currentColor`. Inlined rather
 * than imported: the package pulls in 400+ transitive dependencies, which is an
 * absurd price for three glyphs.
 *
 ...
 * only if you already knew what they were meant to be; the owner's word was
 * "slop". Do not redraw them — replace the path data if a mark changes.
 */
...
/** OpenAI's knot, as used for Codex. */
const CODEX_PATH =
